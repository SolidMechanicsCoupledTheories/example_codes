...
2D axisymmetric sphere lithiation study.
...
#
Gshear   = Constant(49.8e3)    # Shear modulus, MPa
Kbulk    = Constant(83e3)      # Bulk modulus, MPa
# 
...
'''''''''''''''''''''
# Output file setup
file_results = XDMFFile("results/2D_axi_sphere_lithiation.xdmf")
...
plt.figure()
plt.plot(timeHist0[0:ind], timeHist1[0:ind], linewidth=1.0,\
...
plt.tight_layout()
plt.savefig("results/sphere_lithiation_step.png", dpi=600)
