...
'''''''''''''''''''''
# Output file setup
file_results = XDMFFile("results/thermo_gel_axi_sphere_swell.xdmf")
...
#
bcs_2 = DirichletBC(ME.sub(2), muRamp, facets, 7)    # chem. pot. - Oouter
#
bcs_3 = DirichletBC(ME.sub(4), theta0, facets, 7) # Temperature - (outer)
#
...
bcs_2 = DirichletBC(ME.sub(2), muRamp, facets, 7)    # chem. pot. - Oouter
#
bcs_3 = DirichletBC(ME.sub(4), thetaRamp, facets, 7) # Temperature - (outer)
#
bcs = [bcs_1, bcs_2, bcs_3]
...
bcs_2 = DirichletBC(ME.sub(2), muRamp, facets, 7)    # chem. pot. - Oouter
#
bcs_3 = DirichletBC(ME.sub(4), thetaRamp2, facets, 7) # Temperature - (outer)
#
bcs = [bcs_1, bcs_2, bcs_3]
