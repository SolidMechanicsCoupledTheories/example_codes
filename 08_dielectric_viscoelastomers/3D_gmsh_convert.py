...
"""
import meshio
mesh_from_file = meshio.read("meshes/gripper_six.msh")
...
meshio.write("meshes/facet_gripper_six.xdmf", triangle_mesh)

tetra_mesh = create_mesh(mesh_from_file, "tetra", prune_z=False)
meshio.write("meshes/gripper_six.xdmf", tetra_mesh)