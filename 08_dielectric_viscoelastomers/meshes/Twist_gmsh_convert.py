...
"""
import meshio
mesh_from_file = meshio.read("meshes/twist_actuator.msh")
...
meshio.write("meshes/facet_twist_actuator.xdmf", line_mesh)

triangle_mesh = create_mesh(mesh_from_file, "tetra", prune_z=False)
meshio.write("meshes/twist_actuator.xdmf", triangle_mesh)