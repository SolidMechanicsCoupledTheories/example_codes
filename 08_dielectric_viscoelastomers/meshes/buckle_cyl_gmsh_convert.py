...
"""
import meshio
mesh_from_file = meshio.read("meshes/buckle_cylinder.msh")
...
meshio.write("meshes/facet_buckle_cylinder.xdmf", line_mesh)

triangle_mesh = create_mesh(mesh_from_file, "tetra", prune_z=False)
meshio.write("meshes/buckle_cylinder.xdmf", triangle_mesh)