...
Plane strain growth  of a tumor
...
with XDMFFile("meshes/elliptical_inclusion.xdmf") as infile:
    infile.read(mesh)
...
with XDMFFile("meshes/facet_elliptical_inclusion.xdmf") as infile:
...
'''''''''''''''''''''
# Output file setup
file_results = XDMFFile("results/gel_elliptical_tumor_growth.xdmf")
...
plt.tight_layout()
plt.savefig("results/elliptical_tumor_growth_.png", dpi=600) 
