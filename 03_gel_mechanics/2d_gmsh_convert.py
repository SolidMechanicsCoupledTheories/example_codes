...
"""
import meshio
mesh_from_file = meshio.read("meshes/spherical_inclusion.msh")
...
meshio.write("meshes/facet_spherical_inclusion.xdmf", line_mesh)

triangle_mesh = create_mesh(mesh_from_file, "triangle", prune_z=True)
meshio.write("meshes/spherical_inclusion.xdmf", triangle_mesh)