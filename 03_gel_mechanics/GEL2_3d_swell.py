...
bcs_4 = DirichletBC(ME.sub(2), muAmp, facets, 2)     # chem. pot. - xTop
bcs_5 = DirichletBC(ME.sub(2), muAmp, facets, 4)     # chem. pot. - yTop
bcs_6 = DirichletBC(ME.sub(2), muAmp, facets, 6)     # chem. pot. - zTop
# 
...
'''''''''''''''''''''
# Output file setup
file_results = XDMFFile("results/gel_3d_swell.xdmf")
