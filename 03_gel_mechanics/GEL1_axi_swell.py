...
mesh = RectangleMesh(Point(0, 0), Point(L0, H0), 8, 8, "crossed")
...
bcs_3 = DirichletBC(ME.sub(2), muAmp, facets, 3)     # chem. pot. - right
bcs_4 = DirichletBC(ME.sub(2), muAmp, facets, 4)     # chem. pot. - top
# 
bcs = [bcs_2, bcs_3, bcs_4]
...
'''''''''''''''''''''
# Output file setup
file_results = XDMFFile("results/gel_axi_swell.xdmf")
