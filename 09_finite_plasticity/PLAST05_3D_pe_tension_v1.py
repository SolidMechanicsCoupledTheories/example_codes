...
with XDMFFile("meshes/3D_pe_tension_v2.xdmf") as infile:
    infile.read(mesh)
...
with XDMFFile("meshes/facet_3D_pe_tension_v2.xdmf") as infile:
...
# # Gmsh labels
# //+
# Physical Surface("ybot", 58) 
# //+
# Physical Surface("ytop", 59) 
# //+
# Physical Surface("xbot", 60)  
# //+
# Physical Surface("zbot", 61)  
...
'''''''''''''''''''''
# Output file setup
file_results = XDMFFile("results/3D_pe_tension.xdmf")
...
bc1 = DirichletBC(ME.sub(1), Constant(0.0), facets, 58)  #  u2 fix ybot

bc2 = DirichletBC(ME.sub(0), Constant(0.0), facets, 60)  #  u1 fix xbot

bc3 = DirichletBC(ME.sub(2), Constant(0.0), facets, 61)  #  u3 fix zbot

bc4 = DirichletBC(ME.sub(0), Constant(0.0), facets, 59)  #  u1 fix top

bc5 = DirichletBC(ME.sub(1), dispRamp,      facets, 59)  #  u2 move top

bc6 = DirichletBC(ME.sub(2), Constant(0.0), facets, 59)  #  u3 fix top
...
plt.tight_layout()
plt.savefig("results/3D_pe_tension.png", dpi=600)
